...
pub fn StateMachineType(
    ...
    return struct {
        ...
        fn execute(
            ...
            for (events, 0..) |*event_, index| {
                ...
                const result = blk: {
                    ...
                    if (event.flags.imported) {
                        if (chain == null and events.len > 1) {
                            break :blk .imported_event_must_be_linked;
                        }
        ...
        fn create_account(self: *StateMachine, a: *const Account) CreateAccountResult {
            ...
            if (a.flags.imported) {
                // Allows past timestamps, but it validates if it regressed in relation to
...
// The goal is to ensure that imported events validations are covered.
test "imported events" {
    try check(
        \\ tick 10 nanoseconds
        \\
        // The first event determines if the batch is either imported or not.
        \\ account A1  0  0  0  0  _  _  _ _ L1 C1   LNK  _  _  _ IMP _  2 linked_event_failed
        \\ account A2  0  0  0  0  _  _  _ _ L1 C1   _    _  _  _ _   _  0 imported_event_expected
        \\ commit create_accounts
        \\ account A1  0  0  0  0  _  _  _ _ L1 C1   LNK  _  _  _ _   _  0 linked_event_failed
        \\ account A2  0  0  0  0  _  _  _ _ L1 C1   _    _  _  _ IMP _  3 imported_event_not_expected
        \\ commit create_accounts
        \\
        \\ account A1  0  0  0  0  _  _  _ _ L1 C1   _    _  _  _ IMP _  2 imported_event_must_be_linked
        \\ account A2  0  0  0  0  _  _  _ _ L1 C1   _    _  _  _ IMP _  3 imported_event_must_be_linked
        \\ commit create_accounts
        \\
        \\ account A3  0  0  0  0  _  _  _ _ L1 C1   _    _  _  _ IMP _  0 imported_event_timestamp_must_not_be_zero
        \\ commit create_accounts
        \\ account A3  0  0  0  0  _  _  _ _ L1 C1   _    _  _  _ IMP _ 99 imported_event_timestamp_must_not_advance
        \\ commit create_accounts
        \\
        \\ account A1  0  0  0  0  _  _  _ _ L1 C1   LNK  _  _  _ IMP _  2 ok
        \\ account A2  0  0  0  0  _  _  _ _ L1 C1   _    _  _  _ IMP _  3 ok
        \\ commit create_accounts
        \\
        // The timestamp is not subject to an idempotency check.
        \\ account A2  0  0  0  0  _  _  _ _ L1 C1   _    _  _  _ IMP _  3 exists
        \\ commit create_accounts
        \\ account A2  0  0  0  0  _  _  _ _ L1 C1   _    _  _  _ IMP _  4 exists
        \\ commit create_accounts
        \\
        \\ account A3  0  0  0  0  _  _  _ _ L1 C1   _    _  _  _ IMP _  1 imported_event_timestamp_must_not_regress
        \\ commit create_accounts
        \\ account A3  0  0  0  0  _  _  _ _ L1 C1   _    _  _  _ IMP _  2 imported_event_timestamp_must_not_regress
        \\ commit create_accounts
        \\ account A3  0  0  0  0  _  _  _ _ L1 C1   _    _  _  _ IMP _  3 imported_event_timestamp_must_not_regress
        \\ commit create_accounts
        \\
        \\ account A3  0  0  0  0  _  _  _ _ L2 C2   _    _  _  _ IMP _  4 ok
        \\ commit create_accounts
        \\
        \\ transfer   T1 A1 A2    3   _  _  _  _    _ L1 C2   LNK   _   _   _   _   _  IMP _ 10 linked_event_failed
        \\ transfer   T2 A2 A1    4   _  _  _  _    _ L1 C2   _     _   _   _   _   _  _   _ 11 imported_event_expected
        \\ commit create_transfers
        \\ transfer   T1 A1 A2    3   _  _  _  _    _ L1 C2   LNK   _   _   _   _   _  _   _  0 linked_event_failed
        \\ transfer   T2 A2 A1    4   _  _  _  _    _ L1 C2   _     _   _   _   _   _  IMP _ 11 imported_event_not_expected
        \\ commit create_transfers
        \\
        \\ transfer   T1 A1 A2    3   _  _  _  _    _ L1 C2   _     _   _   _   _   _  IMP _ 10 imported_event_must_be_linked
        \\ transfer   T2 A2 A1    4   _  _  _  _    _ L1 C2   _     _   _   _   _   _  IMP _ 11 imported_event_must_be_linked
        \\ commit create_transfers
        \\
        \\ transfer   T1 A1 A2    3   _  _  _  _    _ L1 C2   _     _   _   _   _   _  IMP _  0 imported_event_timestamp_must_not_be_zero
        \\ commit create_transfers
        \\ transfer   T2 A1 A2    4   _  _  _  _    _ L1 C2   _     _   _   _   _   _  IMP _ 99 imported_event_timestamp_must_not_advance
        \\ commit create_transfers
        \\
        ...
        \\ commit create_transfers
        \\
        \\ transfer   T1 A1 A2    3   _  _  _  _    _ L1 C2   LNK   _   _   _   _   _  IMP _ 10 ok
        \\ transfer   T2 A2 A1    4   _  _  _  _    _ L1 C2   LNK   _   _   _   _   _  IMP _ 11 ok
        \\ transfer   T3 A1 A2   10   _  _  _  _    0 L1 C1   _   PEN   _   _   _   _  IMP _ 12 ok
        \\ commit create_transfers
        \\
        \\ transfer   T4 A1 A2   10   _  _  _  _    1 L1 C1   _   PEN   _   _   _   _  IMP _ 13 imported_event_timeout_must_be_zero
        \\ commit create_transfers
        \\ transfer   T4 A1 A2    5   _  _  _  _    _ L1 C2   _     _   _   _   _   _  IMP _  1 imported_event_timestamp_must_not_regress
        \\ commit create_transfers
        \\ transfer   T4 A1 A2    5   _  _  _  _    _ L1 C2   _     _   _   _   _   _  IMP _ 12 imported_event_timestamp_must_not_regress
        \\ commit create_transfers
        \\
        \\ transfer   T5 A1 A2   10  T3 U1 U1 U1    _ L1 C1   _     _ POS   _   _   _  IMP _ 13 ok
        \\ commit create_transfers
        \\
