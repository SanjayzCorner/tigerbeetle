...
typedef enum TB_CREATE_ACCOUNT_RESULT {
    ...
    TB_CREATE_ACCOUNT_IMPORTED_EVENT_MUST_BE_LINKED = 24,
    TB_CREATE_ACCOUNT_TIMESTAMP_MUST_BE_ZERO = 3,
    TB_CREATE_ACCOUNT_IMPORTED_EVENT_TIMESTAMP_MUST_NOT_BE_ZERO = 25,
    TB_CREATE_ACCOUNT_IMPORTED_EVENT_TIMESTAMP_MUST_NOT_ADVANCE = 26,
    ...
    TB_CREATE_ACCOUNT_IMPORTED_EVENT_TIMESTAMP_MUST_NOT_REGRESS = 27,
...
typedef enum TB_CREATE_TRANSFER_RESULT {
    ...
    TB_CREATE_TRANSFER_IMPORTED_EVENT_MUST_BE_LINKED = 58,
    TB_CREATE_TRANSFER_IMPORTED_EVENT_TIMESTAMP_MUST_NOT_BE_ZERO = 59,
    TB_CREATE_TRANSFER_IMPORTED_EVENT_TIMESTAMP_MUST_NOT_ADVANCE = 60,
    ...
    TB_CREATE_TRANSFER_IMPORTED_EVENT_TIMESTAMP_MUST_NOT_REGRESS = 63,
    TB_CREATE_TRANSFER_IMPORTED_EVENT_TIMEOUT_MUST_BE_ZERO = 64,
