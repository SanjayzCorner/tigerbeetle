...
public enum CreateAccountResult {
    ...
    /**
     * @see <a href="https://docs.tigerbeetle.com/reference/requests/create_accounts#imported_event_must_be_linked">imported_event_must_be_linked</a>
     */
    ImportedEventMustBeLinked((int) 24),
     ...
     */
    ImportedEventTimestampMustNotBeZero((int) 25),
     ...
     */
    ImportedEventTimestampMustNotAdvance((int) 26),
     ...
     */
    ImportedEventTimestampMustNotRegress((int) 27);
